(function ($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    showItemTags(gallery, position, tags) {
      var tagItems =
        '<li class="nav-item"><span class="my nav-link active" data-images-toggle="all" id="active-tag">Tous</span></li>';
      $.each(tags, function (index, value) {
        tagItems += `<li class="nav-item">
                <span class="my nav-link" data-images-toggle="${value}">${value}</span></li>`;
      });
